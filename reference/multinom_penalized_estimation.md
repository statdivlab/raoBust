...
- stepSize:
  ...
  The size of the step to take during the parameter update step, used in
  the MLE step.

- arm_c:

  Control parameter for checking Armijo condition, used in the MLE step.

- maxit:

  Maximum number of iterations for augmentation algorithm. Defaults to
  250.

- maxit_fs:

  Maximum number of iterations for Fisher scoring. Defaults to 5.
