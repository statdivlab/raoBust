...
- [`ddPCR`](ddpcr.md) : Digital droplet PCR measurements and metadata
  from a study of people living with cystic fibrosis
...
- [`light_presence`](light_presence.md) :

  Presence and absence of COG 4251 with function Bacteriophytochrome
  (light-regulated signal transduction histidine kinase) within a set of
